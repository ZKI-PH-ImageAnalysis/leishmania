...
import torch
from backbone import DarkNetBackbone, ResNetBackbone, ResNetBackboneGN, VGGBackbone
...
#    {
#        "name": "torbens_test",
#        "valid_info": "/scratch/gloyert/yolact/empty.json",
#        "valid_images": "/scratch/gloyert/Blutbilder/training/972/alte_slides/972x972/",
#        "has_gt": False,
#        "class_names": ("RBC", "WBC", "PLT"),
...
blood_dataset_1 = dataset_base.copy(
    {
        "name": "blood",
        "train_info": "/scratch/gloyert/yolact/data/blood/Model_neu/train/coco_annotations.json",
        "train_images": "/scratch/gloyert/yolact/data/blood/Model_neu/train/images/",
        "valid_info": "/scratch/gloyert/yolact/data/blood/test/coco_annotations.json",
        "valid_images": "/scratch/gloyert/yolact/data/blood/test/images/",
        #"valid_info": "/scratch/gloyert/yolact/data/blood/Model_neu/val/coco_annotations.json",
        #"valid_images": "/scratch/gloyert/yolact/data/blood/Model_neu/val/images/",
        "class_names": ("RBC", "WBC", "PLT"),
        "label_map": {1: 1, 2: 2, 3: 3},
    }
)

blood_dataset_2 = dataset_base.copy(
    {
        "name": "blood2",
        "train_info": "/scratch/gloyert/yolact/data/blood/Model2/train/coco_annotations.json",
        "train_images": "/scratch/gloyert/yolact/data/blood/Model2/train/images/",
        "valid_info": "/scratch/gloyert/yolact/data/blood/test/coco_annotations.json",
        "valid_images": "/scratch/gloyert/yolact/data/blood/test/images/",
        "class_names": ("RBC", "WBC", "PLT"),
        "label_map": {1: 1, 2: 2, 3: 3},
...
blood_dataset_3 = dataset_base.copy(
    {
        "name": "blood3",
        "train_info": "/scratch/gloyert/yolact/data/blood/Model3/train/coco_annotations.json",
        "train_images": "/scratch/gloyert/yolact/data/blood/Model3/train/images/",
        "valid_info": "/scratch/gloyert/yolact/data/blood/test/coco_annotations.json",
        "valid_images": "/scratch/gloyert/yolact/data/blood/test/images/",
        "class_names": ("RBC", "WBC", "PLT"),
        "label_map": {1: 1, 2: 2, 3: 3},
...
yolact_resnet50_blood_config = yolact_resnet50_config.copy(
    {
        "name": "yolact_resnet50_blood",
        # Dataset stuff
        "dataset": blood_dataset_1,
        "num_classes": len(blood_dataset_1.class_names) + 1,
        # Image Size
        "max_size": 1000,
        # Training params
        "masks_to_train": 500,
        ...
        #'backbone': yolact_base_config.backbone.copy({
        #'pred_scales': [[int(x[0] / yolact_base_config.max_size * 1000)] for x in yolact_base_config.backbone.pred_scales],
        # }),
        "pred_aspect_ratios": [[[1, 1 / 2, 2]]] * 5,
        "pred_scales": [
            [i * 2 ** (j / 3.0) for j in range(3)] for i in [24, 48, 96, 192, 384]
        ],
        # halve all of the anchor sizes in "pred_scales" (image size 300x300)
    }
)

yolact_resnet101_blood_config = yolact_base_config.copy(
    {
        "name": "yolact_resnet101_blood",
        # Dataset stuff
        "dataset": blood_dataset_1,
        "num_classes": len(blood_dataset_1.class_names) + 1,
        # Image Size
